...
## [29.0.0](https://github.com/danijelTxFusion/via-core/compare/core-v28.0.0...core-v29.0.0) (2025-12-02)


### ⚠ BREAKING CHANGES

* **contracts:** integrate protocol defense changes ([#2737](https://github.com/danijelTxFusion/via-core/issues/2737))
...
* add `block.timestamp` asserter for AA ([4d0af43](https://github.com/danijelTxFusion/via-core/commit/4d0af43eef617d0226b24d3532c65c473c381cd8))
* add `block.timestamp` asserter for AA ([#3031](https://github.com/danijelTxFusion/via-core/issues/3031)) ([3c20a7c](https://github.com/danijelTxFusion/via-core/commit/3c20a7cd8ea8f131e275d33b240f246c7efbce2f))
* Add CoinMarketCap external API ([#2971](https://github.com/danijelTxFusion/via-core/issues/2971)) ([ec78d51](https://github.com/danijelTxFusion/via-core/commit/ec78d5186f375b8bb5a166b7dea12582047ebee5))
* add EN as a fallback for celestia ([9ba83e6](https://github.com/danijelTxFusion/via-core/commit/9ba83e63a1c2eccad39ae1843b92b3ae323dc8b0))
* add indexer storage init and ([35fe508](https://github.com/danijelTxFusion/via-core/commit/35fe5081efe028ac610dee34a023a4f594ca2a10))
* add log to btc_watch ([7154519](https://github.com/danijelTxFusion/via-core/commit/71545190e6dea02fb88b8b87ed3312b174cd7996))
* add logic to via modules to stop operating when a reorg is found ([1ea291c](https://github.com/danijelTxFusion/via-core/commit/1ea291cd0a4d4cfb050adaae9245a5b50b7e1f4e))
* add logs ([cc3e4d4](https://github.com/danijelTxFusion/via-core/commit/cc3e4d4508488e10b4002f63d1ca20f8ba806a75))
* add metric to track current cbt ratio ([#3020](https://github.com/danijelTxFusion/via-core/issues/3020)) ([7ce9c82](https://github.com/danijelTxFusion/via-core/commit/7ce9c82567783ea2f9788a7f79a15e1feca7354c))
* add more metrics for the tee_prover ([#3276](https://github.com/danijelTxFusion/via-core/issues/3276)) ([504c382](https://github.com/danijelTxFusion/via-core/commit/504c3825b18e74cdbd2412c3df4107fa54b96cd8))
* add reorg detector config ([1368384](https://github.com/danijelTxFusion/via-core/commit/1368384a3e2357dfe3a9c4910954e30c6b7ba21c))
* add support for custom genesis state ([#3259](https://github.com/danijelTxFusion/via-core/issues/3259)) ([5f2b312](https://github.com/danijelTxFusion/via-core/commit/5f2b312f2850305bdd7112fdfc23b0508057af4c))
* add the l1 block number to the system wallet and create a new dal to track the node blocks ([3982c3d](https://github.com/danijelTxFusion/via-core/commit/3982c3d0179221dad96733378f502efe6194ca2f))
...
* **api_server:** support the blob pub and the proof data ([51e4b5e](https://github.com/danijelTxFusion/via-core/commit/51e4b5e0ffc94af3488e49d2149949b439774c57))
* **api-server:** add `yParity` for non-legacy txs ([#3246](https://github.com/danijelTxFusion/via-core/issues/3246)) ([d05dba2](https://github.com/danijelTxFusion/via-core/commit/d05dba2e26afe7dac4ba6cf8b3b5e826cbf9c205))
* **api:** get rid of tx receipt root ([#3187](https://github.com/danijelTxFusion/via-core/issues/3187)) ([d36d4e6](https://github.com/danijelTxFusion/via-core/commit/d36d4e6f1f5e89760cccf3798d009cd1ba7e9e0d))
* **api:** Implement eth_maxPriorityFeePerGas ([#3135](https://github.com/danijelTxFusion/via-core/issues/3135)) ([3229b17](https://github.com/danijelTxFusion/via-core/commit/3229b175ce733ba343c3424eb69f259275032794))
* **api:** include cache log config to Via binaries ([f3b7e1a](https://github.com/danijelTxFusion/via-core/commit/f3b7e1a21acfac34f7f164f916bcb8bd6f617ddf))
* **api:** Integrate new VM into API server (no tracers) ([#3033](https://github.com/danijelTxFusion/via-core/issues/3033)) ([631db04](https://github.com/danijelTxFusion/via-core/commit/631db04e0692d2f2beb1dc1508af710ff8b6d33c))
* **api:** Make acceptable values cache lag configurable ([#3028](https://github.com/danijelTxFusion/via-core/issues/3028)) ([c0d8681](https://github.com/danijelTxFusion/via-core/commit/c0d8681977b13f1aac21a8cc75aabe58dd63d1d9))
* base EVM emulator support ([4498ceb](https://github.com/danijelTxFusion/via-core/commit/4498cebad0992c01f4376d595262b64f26e80788))
* base token integration tests ([#2509](https://github.com/danijelTxFusion/via-core/issues/2509)) ([d7680a2](https://github.com/danijelTxFusion/via-core/commit/d7680a2867a35af120fcdab8430725eadb505037))
* change seal criteria for gateway ([#3320](https://github.com/danijelTxFusion/via-core/issues/3320)) ([edbdfe5](https://github.com/danijelTxFusion/via-core/commit/edbdfe58eb164e67fce47f830e49017ff8eba527))
* **configs:** Add port parameter to ConsensusConfig ([#2986](https://github.com/danijelTxFusion/via-core/issues/2986)) ([828f08e](https://github.com/danijelTxFusion/via-core/commit/828f08e4e84368590eb39f01ca72814412302f5c))
* **configs:** Add port parameter to ConsensusConfig ([#3051](https://github.com/danijelTxFusion/via-core/issues/3051)) ([fdea410](https://github.com/danijelTxFusion/via-core/commit/fdea4105597144fe1116d552608bae4a83ab548b))
...
* **consensus:** enabled syncing pregenesis blocks over p2p ([#3192](https://github.com/danijelTxFusion/via-core/issues/3192)) ([e3bcb14](https://github.com/danijelTxFusion/via-core/commit/e3bcb14936e1d914282922c0bc01f47d708dde14))
* **consensus:** fallback json rpc syncing for consensus ([#3211](https://github.com/danijelTxFusion/via-core/issues/3211)) ([c2c6752](https://github.com/danijelTxFusion/via-core/commit/c2c6752d47d64f1ab2d6692d70d567d4f7868b55))
* **consensus:** smooth transition to p2p syncing (BFT-515) ([#3075](https://github.com/danijelTxFusion/via-core/issues/3075)) ([999c4bc](https://github.com/danijelTxFusion/via-core/commit/999c4bcc7c5c985c4fbe4dcf354090d338db0566))
...
* **contract-verifier:** Adapt contract verifier API for EVM bytecodes ([#3234](https://github.com/danijelTxFusion/via-core/issues/3234)) ([000bcc7](https://github.com/danijelTxFusion/via-core/commit/000bcc7fab833b391a458c3d76d329a662cb3b51))
* **contract-verifier:** Download compilers from GH automatically ([#3291](https://github.com/danijelTxFusion/via-core/issues/3291)) ([b0b548d](https://github.com/danijelTxFusion/via-core/commit/b0b548d57fc24d22ce24c01bd39dcedd7d37babd))
...
* **contract-verifier:** Support Vyper toolchain for EVM bytecodes ([#3251](https://github.com/danijelTxFusion/via-core/issues/3251)) ([90455bc](https://github.com/danijelTxFusion/via-core/commit/90455bcc22d498f0165ad536d1a46f4189a8e45e))
* **contracts:** integrate protocol defense changes ([#2737](https://github.com/danijelTxFusion/via-core/issues/2737)) ([cb5f3c2](https://github.com/danijelTxFusion/via-core/commit/cb5f3c2aeb7fcf5aaad8d59d47aadd234db1aec2))
* create via consensus lib and remove batch finalization threshold from envs ([cbd2825](https://github.com/danijelTxFusion/via-core/commit/cbd28255f130098e72745e446fe7457b1ead3762))
* **da-clients:** add Celestia client ([#2983](https://github.com/danijelTxFusion/via-core/issues/2983)) ([90ab192](https://github.com/danijelTxFusion/via-core/commit/90ab19267475d1f99ed4d2580f8c230767aa2e6e))
* **da-clients:** add EigenDA client ([#3155](https://github.com/danijelTxFusion/via-core/issues/3155)) ([ccca0dc](https://github.com/danijelTxFusion/via-core/commit/ccca0dc2b1f913cd52d5f2e7f3664062b1715a42))
...
* **en:** periodically fetch bridge addresses ([#2949](https://github.com/danijelTxFusion/via-core/issues/2949)) ([4001cdc](https://github.com/danijelTxFusion/via-core/commit/4001cdc6974ded8d655c15ba1aab51ae73b068fd))
* **en:** Support Merkle tree recovery with pruning enabled ([#3172](https://github.com/danijelTxFusion/via-core/issues/3172)) ([d87c5dc](https://github.com/danijelTxFusion/via-core/commit/d87c5dc01969f96eeda9249a02a89fc9f67d19e0))
* **eth-sender:** add a cap to time_in_mempool ([#2978](https://github.com/danijelTxFusion/via-core/issues/2978)) ([49b46f6](https://github.com/danijelTxFusion/via-core/commit/49b46f6b309cc8520548a73e5699395bbd905f06))
* **eth-sender:** add time_in_mempool_cap config ([#3018](https://github.com/danijelTxFusion/via-core/issues/3018)) ([98b4d68](https://github.com/danijelTxFusion/via-core/commit/98b4d688258251ac1a55283db60975143c129b8a))
* **eth-watch:** catch another reth error ([#3026](https://github.com/danijelTxFusion/via-core/issues/3026)) ([8c16988](https://github.com/danijelTxFusion/via-core/commit/8c1698861a44d809e81434d955637c6b8f2e23e4))
* **eth-watch:** redesign to support multiple chains ([#2867](https://github.com/danijelTxFusion/via-core/issues/2867)) ([b66c467](https://github.com/danijelTxFusion/via-core/commit/b66c467f6aa7b24965c51879b9826dc61bee4111))
* Expose http debug page ([#2952](https://github.com/danijelTxFusion/via-core/issues/2952)) ([c70960a](https://github.com/danijelTxFusion/via-core/commit/c70960af587e2906774efac4e0cc71c947c2cff1))
* **external-node:** save protocol version before opening a batch ([#3136](https://github.com/danijelTxFusion/via-core/issues/3136)) ([9d388a9](https://github.com/danijelTxFusion/via-core/commit/9d388a90553ca210130f4793fd851acc47f7cfa3))
* fetch the system wallets based on the l1 block number ([859e831](https://github.com/danijelTxFusion/via-core/commit/859e831ad938d8376db1ad9258e431058a513243))
* gateway preparation ([60562af](https://github.com/danijelTxFusion/via-core/commit/60562af6c9c1ac162387cb723cbd8774da91e889))
...
* Handle new yul compilation flow ([#3038](https://github.com/danijelTxFusion/via-core/issues/3038)) ([d168aae](https://github.com/danijelTxFusion/via-core/commit/d168aae21498113c2f920a01b537a0a830acf47a))
* Implement gas relay mode and inclusion data for data attestation ([#3070](https://github.com/danijelTxFusion/via-core/issues/3070)) ([c931e7d](https://github.com/danijelTxFusion/via-core/commit/c931e7dc6f2a749df112d50a0e7f9b8762adcfaa))
* integrate gateway changes for some components ([9a671cc](https://github.com/danijelTxFusion/via-core/commit/9a671cc57f502c8607232067a751cfc53c59d762))
* integrate gateway changes for some components ([#3274](https://github.com/danijelTxFusion/via-core/issues/3274)) ([0354888](https://github.com/danijelTxFusion/via-core/commit/03548885eb9b4b82956a4ead03ec1ca00056c3f4))
* **metadata-calculator:** Add debug endpoints for tree API ([#3167](https://github.com/danijelTxFusion/via-core/issues/3167)) ([6880f73](https://github.com/danijelTxFusion/via-core/commit/6880f7337aa49b49a0f0996d0b4d3c18ffb11af2))
...
* **proof-data-handler:** add first processed batch option ([#3112](https://github.com/danijelTxFusion/via-core/issues/3112)) ([0b0cce2](https://github.com/danijelTxFusion/via-core/commit/0b0cce220da01ff3e9995717991aad39a5fae313))
* **proof-data-handler:** add tee_proof_generation_timeout_in_secs param ([#3128](https://github.com/danijelTxFusion/via-core/issues/3128)) ([0035de4](https://github.com/danijelTxFusion/via-core/commit/0035de40fafd50d66f55700011ded831aef52d13))
* **proof-data-handler:** exclude batches without object file in GCS  ([#2980](https://github.com/danijelTxFusion/via-core/issues/2980)) ([4d0540c](https://github.com/danijelTxFusion/via-core/commit/4d0540cbefc9ecd7831bf555bfbee1cc257235c2))
* Prover e2e test ([#2975](https://github.com/danijelTxFusion/via-core/issues/2975)) ([e239e67](https://github.com/danijelTxFusion/via-core/commit/e239e67b514c21636ef979b7c8fc628d721caf2c))
...
* **pruning:** Record L1 batch root hash in pruning logs ([#3266](https://github.com/danijelTxFusion/via-core/issues/3266)) ([ca13217](https://github.com/danijelTxFusion/via-core/commit/ca13217266ecb97ad4ed73738cb29cb0a10975fe))
* **reorg_detector:** add check for canonical chain before insert into db, this will make sure that the last inserted block is valid ([b72360f](https://github.com/danijelTxFusion/via-core/commit/b72360ffe54388177297a41c4623773f89dd827d))
* **state-keeper:** mempool io opens batch if there is protocol upgrade tx ([#3360](https://github.com/danijelTxFusion/via-core/issues/3360)) ([c6218f6](https://github.com/danijelTxFusion/via-core/commit/c6218f6597ff0199c29d4c7d60df0a539f401c9e))
* **state-keeper:** pre-insert unsealed L1 batches ([#2846](https://github.com/danijelTxFusion/via-core/issues/2846)) ([7aa0ec8](https://github.com/danijelTxFusion/via-core/commit/7aa0ec8449d69bc3ff375bb366f56c79029bcaf5))
...
* **tee_verifier:** speedup SQL query for new jobs ([#3133](https://github.com/danijelTxFusion/via-core/issues/3133)) ([86999de](https://github.com/danijelTxFusion/via-core/commit/86999deed2ea4a0ba908782e32ed39e2ee34cb63))
* **tee:** add error handling for unstable_getTeeProofs API endpoint ([#3321](https://github.com/danijelTxFusion/via-core/issues/3321)) ([98c9dd9](https://github.com/danijelTxFusion/via-core/commit/98c9dd9eb95699d0eb601bb730e8e74c59d301c7))
* **vai_da_dispatcher_lib:** add reusable code in the vai_da_dispatcher_lib ([b4d6c04](https://github.com/danijelTxFusion/via-core/commit/b4d6c04b998f51f19ae5f906c3a168c14b9403b8))
* **via_block_reverter:** integrate the reorg logic to the block reverter and add helpers to clean the state ([b1a43b1](https://github.com/danijelTxFusion/via-core/commit/b1a43b173c52752d9eaf4f56df5f4cf5ba1cce78))
* **via_btc_client:** implement the withdrawal parser and fix tests ([40c4b39](https://github.com/danijelTxFusion/via-core/commit/40c4b39a76a80af9bf40a8831c8ea3d940df0300))
* **via_btc_sender:** wait for DA inclusion before process inscriptions ([b187ad5](https://github.com/danijelTxFusion/via-core/commit/b187ad589da14b5ee9026b4c754082af4b3aecd1))
* **via_btc_watch:** moving the state init from the node btc watch to node init module ([0b80d25](https://github.com/danijelTxFusion/via-core/commit/0b80d25ffa9a6c0fdd6eee7c2f55b484e90b844b))
* **via_config:** add l2 secrets config ([c42c71d](https://github.com/danijelTxFusion/via-core/commit/c42c71d6057d8dd35057eed3fa46bde46609b428))
* **via_core:** improve logging and metrics ([cfec275](https://github.com/danijelTxFusion/via-core/commit/cfec2756997111bd7dc107d33249171c490df0bd))
* **via_da_client_en:** add logic to return proof data and make the EN client optional for the node ([9364422](https://github.com/danijelTxFusion/via-core/commit/9364422a4b9272796c54ea2da468c19043575735))
* **via_da_client:** add chunk reconstruction logic to the celestia client ([ac9be12](https://github.com/danijelTxFusion/via-core/commit/ac9be12674be568b6ac92b20e598b29145a6fcea))
* **via_da_dispatcher:** implement chunk blob logic ([6c38444](https://github.com/danijelTxFusion/via-core/commit/6c384449a4fc6308a30ed6707a1d0fb96e549f08))
* **via_external_node:** add reorg detector to the EN ([fc9871a](https://github.com/danijelTxFusion/via-core/commit/fc9871a01d08812332aa7e1ccf35208757e9b1fb))
* **via_main_node_reorg_detector:** implement the node reorg detector ([1d429f9](https://github.com/danijelTxFusion/via-core/commit/1d429f9d2e77e524d0ccb8e0d08c8e3d972c0764))
* **via_query_client:** add l2 query client and update configs ([efeea9c](https://github.com/danijelTxFusion/via-core/commit/efeea9c88d960acc323a5de1d154b2d189c2496e))
* **via_server:** integrate the reorg detector to the server orchestration layer ([23c88ba](https://github.com/danijelTxFusion/via-core/commit/23c88ba5b6dfbf7667fa651c57dc7bf441a33119))
...
* **via_state_keeper:** mempool io opens batch if there is protocol upgrade tx ([b66786b](https://github.com/danijelTxFusion/via-core/commit/b66786b5c1e8a13e133743d7db8482b7f11f9521))
* **via_verifier_block_detector:** implement the reorg detector logic ([7349ff1](https://github.com/danijelTxFusion/via-core/commit/7349ff1878b09eeec7b1cbdc8bf0c014874d4d74))
* **via_verifier_block_reverter:** implement the block reverter to rollback the verifier state when reorg detected ([ed7012b](https://github.com/danijelTxFusion/via-core/commit/ed7012b67ac723857004f4b5d0f68f0595e3211e))
* **via_verifier_btc_watch:** allow the verifier to  process finalized when a reorg fork is found ([26a7b49](https://github.com/danijelTxFusion/via-core/commit/26a7b49206e084ac178e863460a3ab8c13f30ef2))
* **via_verifier_btc_watch:** moving the state init from the verifier btc watch to verifier init module ([40685f1](https://github.com/danijelTxFusion/via-core/commit/40685f1c6aaa450dc5a9234d2db1c08e9c33f660))
* **via_verifier_dal:** add the l1 block number to the system wallet and create a new dal to track the node blocks ([8398336](https://github.com/danijelTxFusion/via-core/commit/8398336d87e57b586211e6514a01bf8e79e69308))
* **via-cli:** update the deposit cmd to allow external api for fee ([da95b10](https://github.com/danijelTxFusion/via-core/commit/da95b10bfabcb1adf265e7c089e930c8dbaf31dd))
* **via-da-http:** implement an http DA client ([ae78f47](https://github.com/danijelTxFusion/via-core/commit/ae78f47a8576b7fa7e953547ad61bb7d91bb027e))
* **vm_executor:** Add new histogram metric for gas per tx in vm_executor ([#3215](https://github.com/danijelTxFusion/via-core/issues/3215)) ([131c383](https://github.com/danijelTxFusion/via-core/commit/131c383d0c5483b5f9138180b50c3f8100a890c9))
* vm2 account validation ([#2863](https://github.com/danijelTxFusion/via-core/issues/2863)) ([156f325](https://github.com/danijelTxFusion/via-core/commit/156f325d99f50efcf3fffdc25771c5764795f17f))
...
* **vm:** add gateway changes to fast vm ([#3236](https://github.com/danijelTxFusion/via-core/issues/3236)) ([011aa42](https://github.com/danijelTxFusion/via-core/commit/011aa42750372bd7be7c47b00edfde23d7e363ea))
...
* **vm:** Return compressed bytecodes from `push_transaction()` ([#3126](https://github.com/danijelTxFusion/via-core/issues/3126)) ([2b73705](https://github.com/danijelTxFusion/via-core/commit/2b73705305849086c3c86e9787b0fefc008f3f03))
* **vm:** Support EVM emulation in fast VM ([#3163](https://github.com/danijelTxFusion/via-core/issues/3163)) ([e7d44e1](https://github.com/danijelTxFusion/via-core/commit/e7d44e1731ac581d2199849885571f5f815f1da8))
* **zk_toolbox:** add fees integration test to toolbox ([#2898](https://github.com/danijelTxFusion/via-core/issues/2898)) ([5800b3f](https://github.com/danijelTxFusion/via-core/commit/5800b3fffb8b0ca0ec4cc59a0b179ca96b2c7cd1))
...
* **zk_toolbox:** added support for setting attester committee defined in a separate file ([#2992](https://github.com/danijelTxFusion/via-core/issues/2992)) ([2f85a8b](https://github.com/danijelTxFusion/via-core/commit/2f85a8b4671ef00859e21a10f7d7e7a5cc7ec71b))
...
* **zksync_cli:** Health checkpoint improvements ([#3193](https://github.com/danijelTxFusion/via-core/issues/3193)) ([817a280](https://github.com/danijelTxFusion/via-core/commit/817a280f58932a7fd5f1338159f915489f39a49f))
* **zktoolbox:** added checking the contract owner in set-attester-committee command ([#3061](https://github.com/danijelTxFusion/via-core/issues/3061)) ([61dae7c](https://github.com/danijelTxFusion/via-core/commit/61dae7c2331651ba4c94395571c8b29229e12f73))


### Bug Fixes

* add updated system contracts for bitcoin vm ([e4dc39f](https://github.com/danijelTxFusion/via-core/commit/e4dc39f1898ad7ddc9b74fd94114ae1cf14c8d72))
* **api:** Accept integer block count in `eth_feeHistory` ([#3077](https://github.com/danijelTxFusion/via-core/issues/3077)) ([255f9d4](https://github.com/danijelTxFusion/via-core/commit/255f9d49a31f82c2e0644f31475a430d13058062))
* **api:** Adapt `eth_getCode` to EVM emulator ([#3073](https://github.com/danijelTxFusion/via-core/issues/3073)) ([001fa2b](https://github.com/danijelTxFusion/via-core/commit/001fa2baa2054e230fd93cf14ab729c0770b1806))
* **api:** batch fee input scaling for `debug_traceCall` ([#3344](https://github.com/danijelTxFusion/via-core/issues/3344)) ([72047e6](https://github.com/danijelTxFusion/via-core/commit/72047e6974fa257c166b62e731b14c38171622c2))
* **api:** Fix batch fee input for `debug` namespace ([#2948](https://github.com/danijelTxFusion/via-core/issues/2948)) ([8d724de](https://github.com/danijelTxFusion/via-core/commit/8d724de1cfa9cd8021c35b65b847756a7951848c))
* bincode deserialization for VM run data ([#3044](https://github.com/danijelTxFusion/via-core/issues/3044)) ([c4a9d0d](https://github.com/danijelTxFusion/via-core/commit/c4a9d0da2dfa0e61648ec663d3fbcc1f17a22716))
* bincode deserialize for WitnessInputData ([#3055](https://github.com/danijelTxFusion/via-core/issues/3055)) ([3169503](https://github.com/danijelTxFusion/via-core/commit/3169503787ac43672a50b6de989ffe4939ca6387))
* block the zk verification if not in sync and use the verifier state lib ([ba5ea34](https://github.com/danijelTxFusion/via-core/commit/ba5ea34647ca0e6f5a61da9517a00f264e2b68c5))
* **btc_client:** include the context inscription when calculate the balance. ([ae0c065](https://github.com/danijelTxFusion/via-core/commit/ae0c065632d55802502cab0d45e5c3373437ee84))
* **btc_sender:** update metrics to export the wallet address ([40b5df4](https://github.com/danijelTxFusion/via-core/commit/40b5df48fdfd4cd5579981e082f7f2bcd8040bc8))
* **btc_sender:** update the inscriber context before each cycle ([3ad4bdb](https://github.com/danijelTxFusion/via-core/commit/3ad4bdb3116e1b61109273d842f915643c236607))
* **call_tracer:** Flat call tracer fixes for blocks ([#3095](https://github.com/danijelTxFusion/via-core/issues/3095)) ([29e7622](https://github.com/danijelTxFusion/via-core/commit/29e7622c530877d60c3dff9a76ee7a22aabc3ebf))
* chainstack block limit exceeded ([#2974](https://github.com/danijelTxFusion/via-core/issues/2974)) ([db3d220](https://github.com/danijelTxFusion/via-core/commit/db3d220ab0de23fcd8653970bac21d6a7821796b))
* clamp the btc_watch to process the batches until the last validated ones from the reorg detector ([430713b](https://github.com/danijelTxFusion/via-core/commit/430713bbb3e3b59f976e3d21d014ea2fa29dc4d2))
* **consensus:** better logging of errors ([#3170](https://github.com/danijelTxFusion/via-core/issues/3170)) ([d47306e](https://github.com/danijelTxFusion/via-core/commit/d47306e030827e22ef70ce5c6794ca28560e4353))
* **consensus:** made attestation controller non-critical ([#3180](https://github.com/danijelTxFusion/via-core/issues/3180)) ([b41211c](https://github.com/danijelTxFusion/via-core/commit/b41211c1210c133e8315749517d6a007865fc7f4))
* **consensus:** payload encoding protected by protocol_version ([#3168](https://github.com/danijelTxFusion/via-core/issues/3168)) ([15eb982](https://github.com/danijelTxFusion/via-core/commit/15eb982bfe0ef082d9e12bf7a8ab116f5e483a0f))
* **consensus:** preventing config update reverts ([#3148](https://github.com/danijelTxFusion/via-core/issues/3148)) ([39037b5](https://github.com/danijelTxFusion/via-core/commit/39037b5943057fd0ddbdb8d3c74a4646e92fb250))
* **contract-verifier:** Fix version extraction in gh resolver ([#3378](https://github.com/danijelTxFusion/via-core/issues/3378)) ([ca0af2a](https://github.com/danijelTxFusion/via-core/commit/ca0af2a57d95daa0dd26233c73f3420223e35d31))
* **da-clients:** add padding to the data within EigenDA blob ([#3203](https://github.com/danijelTxFusion/via-core/issues/3203)) ([d5bb60d](https://github.com/danijelTxFusion/via-core/commit/d5bb60d95447721c9e19a104b02139c9e01958f3))
* **da-clients:** enable tls-roots feature for tonic ([#3201](https://github.com/danijelTxFusion/via-core/issues/3201)) ([cf62f87](https://github.com/danijelTxFusion/via-core/commit/cf62f876532d4b937f43ef72f3d1833b5960ed0b))
* delete priority tx sql query ([915dc66](https://github.com/danijelTxFusion/via-core/commit/915dc660be093bbc2cb03d97860b89567a14f3b4))
* delete soft reorg ([1f6c155](https://github.com/danijelTxFusion/via-core/commit/1f6c1554ae4e6bc3b746e2786ea9f41c838b3a58))
* **en:** add gas estimation optimization in config ([c4c5db5](https://github.com/danijelTxFusion/via-core/commit/c4c5db57cc1a69ee0af35796385b5dcc687334bd))
* **en:** exclude refresh interval from bridge addresses ([6b54625](https://github.com/danijelTxFusion/via-core/commit/6b54625235b702ddad6f5b548dc3115c31cec109))
* **en:** fix metrics ([60c7752](https://github.com/danijelTxFusion/via-core/commit/60c7752a35d67d823ddba1314ac4ba280666a0c5))
* **en:** Repair stale keys for tree in background ([c3f8db2](https://github.com/danijelTxFusion/via-core/commit/c3f8db24e48d0f3bd70bfb448896c7ffe82f86b2))
* **en:** resolve node builder issues ([7c17a53](https://github.com/danijelTxFusion/via-core/commit/7c17a532232d6e3217e07fd763d777718a3bff39))
* **en:** Return `SyncState` health check ([#3142](https://github.com/danijelTxFusion/via-core/issues/3142)) ([643ac2f](https://github.com/danijelTxFusion/via-core/commit/643ac2f9a069a39708ebc4cf507a99d7834320cb))
* **eth-watch:** add missing check that from_block is not larger than finalized_block ([#2969](https://github.com/danijelTxFusion/via-core/issues/2969)) ([304a725](https://github.com/danijelTxFusion/via-core/commit/304a7259fa630473272e87354c678adcf02f946b))
* extend allowed storage slots for validation as per EIP-7562 ([#3166](https://github.com/danijelTxFusion/via-core/issues/3166)) ([3bd787f](https://github.com/danijelTxFusion/via-core/commit/3bd787f6b55a65573536f59ea3a12fbccdd499f6))
* **external-node:** delete empty unsealed batch on EN initialization ([#3125](https://github.com/danijelTxFusion/via-core/issues/3125)) ([6935412](https://github.com/danijelTxFusion/via-core/commit/69354126ad9a96e6306fcf6aab4f9dc35de1d4bc))
* **external-node:** make fetcher rely on unsealed batches  ([#3088](https://github.com/danijelTxFusion/via-core/issues/3088)) ([9d46976](https://github.com/danijelTxFusion/via-core/commit/9d46976f8e855c0704cc7ca5d7c442e2f5d778d8))
* Fix counter metric type to be Counter. ([#3153](https://github.com/danijelTxFusion/via-core/issues/3153)) ([5287880](https://github.com/danijelTxFusion/via-core/commit/52878806258ee5057dda11dae249fc9d9a252654))
* Health checkpoint improvements ([a36bf92](https://github.com/danijelTxFusion/via-core/commit/a36bf922938585cf8a4e7b9523b2f8aa4645c69c))
...
* increase the target blocks when estimate the fees to avoid node errors like "Insufficient data or no feerate found" ([d3e229b](https://github.com/danijelTxFusion/via-core/commit/d3e229bf607120787b92da0d95003fcaa45b1d8f))
* **mempool:** minor mempool improvements ([#3113](https://github.com/danijelTxFusion/via-core/issues/3113)) ([383627f](https://github.com/danijelTxFusion/via-core/commit/383627fa5e2b2f8bde081746b4c4ade5bb6e06d5))
* **merkle-tree:** Fix tree truncation ([#3178](https://github.com/danijelTxFusion/via-core/issues/3178)) ([4945611](https://github.com/danijelTxFusion/via-core/commit/49456117b73a8b67fb8e74206c02c4e322b88e16))
* **merkle-tree:** Repair stale keys for tree in background ([#3200](https://github.com/danijelTxFusion/via-core/issues/3200)) ([2e3b0eb](https://github.com/danijelTxFusion/via-core/commit/2e3b0eb0c2ae265e112106196430560b3ff160b7))
* remove bridge address from the via api namespace ([294e8b7](https://github.com/danijelTxFusion/via-core/commit/294e8b70a9b1d0c6f8dd1e682a74422ff7c87b8e))
* reset the indexer last indexed block when a reorg is detected but ([991ae29](https://github.com/danijelTxFusion/via-core/commit/991ae290b4d4145ec2595f44f40aaa22e5536776))
* resovle conflicts among VM versions for Via and ZKsync ([7fe7cc0](https://github.com/danijelTxFusion/via-core/commit/7fe7cc0c6aedb5cf071179225d7182169d8b7287))
* resovle missing DA secrets ([9d9b3ca](https://github.com/danijelTxFusion/via-core/commit/9d9b3ca5b7c7766998b1839e65521d23f044ea26))
* restore instruction count functionality ([#3081](https://github.com/danijelTxFusion/via-core/issues/3081)) ([960a6e3](https://github.com/danijelTxFusion/via-core/commit/960a6e31c7db497e07ba6d6e5c9bebf1f4498efe))
* **state-keeper:** ensure unsealed batch is present during IO init ([#3071](https://github.com/danijelTxFusion/via-core/issues/3071)) ([96e9b14](https://github.com/danijelTxFusion/via-core/commit/96e9b1468eac64b32de967899de287b12e05f35d))
* **state-keeper:** save call trace for upgrade txs ([#3132](https://github.com/danijelTxFusion/via-core/issues/3132)) ([ca98f8c](https://github.com/danijelTxFusion/via-core/commit/ca98f8c5b5c660f7cf2d7804fc5e38eeac242b80))
* **tee_prover:** add prometheus pull listener ([#3169](https://github.com/danijelTxFusion/via-core/issues/3169)) ([da784a1](https://github.com/danijelTxFusion/via-core/commit/da784a1c482e76956967bd2bf1c19696703ff06f))
* **tee_prover:** add zstd compression ([#3144](https://github.com/danijelTxFusion/via-core/issues/3144)) ([19af3e0](https://github.com/danijelTxFusion/via-core/commit/19af3e0528eb650405ccf9d22cfe3eb2f8be0a68))
...
* **tee:** correct previous fix for race condition in batch locking ([#3358](https://github.com/danijelTxFusion/via-core/issues/3358)) ([1bbd054](https://github.com/danijelTxFusion/via-core/commit/1bbd054c747168d9fafefd9f70bbecf83d3ee5c0))
* **tee:** fix race condition in batch locking ([#3342](https://github.com/danijelTxFusion/via-core/issues/3342)) ([8ec4d71](https://github.com/danijelTxFusion/via-core/commit/8ec4d71a22c2eb7775ed121e6af9cb970808f984))
* the orchestration layer for the verifier and node ([b623158](https://github.com/danijelTxFusion/via-core/commit/b6231588935126ddecd6eda9fa8832c9d4f5460c))
* the verifier deposit message processor and clean code ([db2b490](https://github.com/danijelTxFusion/via-core/commit/db2b490c694fbc7ea4cbf4437363f2772c36a3a6))
* **tracer:** Add error to flat tracer ([#3306](https://github.com/danijelTxFusion/via-core/issues/3306)) ([93999f2](https://github.com/danijelTxFusion/via-core/commit/93999f21b8d857056c8c87656c1daeabb73a0375))
* **tracer:** adds vm error to flatCallTracer error field if exists ([#3374](https://github.com/danijelTxFusion/via-core/issues/3374)) ([96e8585](https://github.com/danijelTxFusion/via-core/commit/96e85850d251ee36f6f2eb49a679f0b020cbe52b))
* update logging in cbt l1 behaviour ([#3149](https://github.com/danijelTxFusion/via-core/issues/3149)) ([5512df6](https://github.com/danijelTxFusion/via-core/commit/5512df62086c71e2ce719b269305452425b31984))
* use_dummy_inclusion_data condition ([#3244](https://github.com/danijelTxFusion/via-core/issues/3244)) ([9d20c50](https://github.com/danijelTxFusion/via-core/commit/9d20c508ae77294c9d122dc9b5f7433eb3f69a8b))
* verifier soft reorg ([b7267f6](https://github.com/danijelTxFusion/via-core/commit/b7267f618c0ae9ab0d75e33e33a57e1bf9f0a198))
* **via_btc_sender:** fix tests ([3e5c0a2](https://github.com/danijelTxFusion/via-core/commit/3e5c0a204df949e7c6787d6ffcf768991668c3c1))
* **via_da_dal:** add helper function to get the proof batch data and fix the pubdata query ([fb895ca](https://github.com/danijelTxFusion/via-core/commit/fb895ca446ee2ee06ba85045a2c618301990222c))
* **via_en:** external node orchestration layer and config ([b4e1f15](https://github.com/danijelTxFusion/via-core/commit/b4e1f15cde6cade1e353c5007f304d5c4be52d7a))
* **via_server:** add missing `gas_adjuster_layer` when initializing only http or ws component ([fe906a2](https://github.com/danijelTxFusion/via-core/commit/fe906a2bfa761a96dc382632cac47fa94f0ae4e7))
* **via_state_keeper:** ensure unsealed batch is present during IO init ([58eba7e](https://github.com/danijelTxFusion/via-core/commit/58eba7e7cbfdea46706a01d4b59cd1890a83f67d))
* **via_state_keeper:** save call trace for upgrade txs ([1a0631c](https://github.com/danijelTxFusion/via-core/commit/1a0631c1862d6f016369bcc2dd330419d94784ed))
* **via_state_keeper:** support unsealed batches ([a38f550](https://github.com/danijelTxFusion/via-core/commit/a38f550c3e1ae7c5a6b6c2e4d3b7188454774e33))
* **via_state_keeper:** tag the connection ([7755d26](https://github.com/danijelTxFusion/via-core/commit/7755d260a8da8cc57f58c08d2e1073050607305d))
* **via-da-clients:** refactor and fix the data encoding for http client ([8352d66](https://github.com/danijelTxFusion/via-core/commit/8352d6657f47abb6477bec6ccf3d73bfd42f765c))
* **vm:** Check protocol version for fast VM ([#3080](https://github.com/danijelTxFusion/via-core/issues/3080)) ([204ebd3](https://github.com/danijelTxFusion/via-core/commit/204ebd36e5f93de91394b6a1af5ef3b1da37b299))
* **vm:** Do not require experimental VM config ([#3270](https://github.com/danijelTxFusion/via-core/issues/3270)) ([f932485](https://github.com/danijelTxFusion/via-core/commit/f9324850c4166871c48ceb4c0396322d9e95bce6))
...
* **api:** More efficient gas estimation ([#2937](https://github.com/danijelTxFusion/via-core/issues/2937)) ([05403a6](https://github.com/danijelTxFusion/via-core/commit/05403a68ee37f559e80b90f965c060698c6b658b))


### Reverts

* **configs:** Add port parameter to ConsensusConfig ([#2986](https://github.com/danijelTxFusion/via-core/issues/2986)) ([#3046](https://github.com/danijelTxFusion/via-core/issues/3046)) ([75fef34](https://github.com/danijelTxFusion/via-core/commit/75fef34227433ac8b67b96de3f333e102d414c55))
